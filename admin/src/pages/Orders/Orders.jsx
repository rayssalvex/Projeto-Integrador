...
const Order = () => {
  ...
  const getOrderClass = (status) => {
    switch (status) {
      case ' Embalando pedido':
        return 'order-item-preparando';
      case 'Saiu para Transportadora':
      ...
      {showFilters && (
        <div className='filters'>
          ...
          <select name='status' value={filters.status} onChange={handleFilterChange} >
            ...
            <option value='Preparando pedido'>Embalado pedido</option>
            <option value='Saiu para entrega'>Saiu para Tranportadora</option>
          ...
          <div key={index} className={`order-item ${getOrderClass(order.status)}`}>
            ...
            <div className="status-action">
              <select onChange={(e) => statusHandler(e, order._id)} value={order.status} name="" id="">
                <option value="Embalando pedido">Embalando pedido</option>
